...
\\
\end{comment}
The superpotential \eqref{eqn:kutasov_superpotential_X} drives the theory to a new IR point since it is either relevant or dangerously irrelevant, depending on the value of $k$ \cite{Kutasov:1995np}.
\\
