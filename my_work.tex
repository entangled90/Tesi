...
&\int  \prod_{i=1}^{ k N_f - N_c } \frac{d \sigma_i }{\sqrt{-\omega_1 \omega_2}}\,  \prod_{i=1}^{ k } \frac{d \rho_i}{\sqrt{-\omega_1 \omega_2}} \, d \xi \, e^{2 \pi i \xi ( \sum \sigma_i + \sum \rho_i)}  \\
...
& \begin{aligned}
 ...
 \end{aligned}
\end{equation}
For the moment we left the R-charge $\Delta_M$ even though it's the charge of the quark we integrated. It's value is fixed with respect to the other charges by using the condition \eqref{eqn:R-symm Anomaly} and we will remove it later.\\
...
\begin{equation}
 \xi \; \longrightarrow \; \frac{\xi}{\omega_1 \omega_2} \qquad \longrightarrow e^{\frac{2 \pi i}{\omega_1 \omega_2} \xi (\sum_i \sigma_i + \sum_j \rho_j)}
\end{equation}
...
\begin{equation}
 ...
 \end{aligned}
 \end{equation} 
Moreover, this shift make the $U(k)$ quarks uncharged under the baryonic symmetry. In fact, it cancels exactly their contribution proportional to the baryonic real mass in the partition function.\\
...
& \begin{aligned}
 ...
 \end{aligned}\\
 & \bigg(\prod_{i=1}^{k} \Gamma_h \big( \pm \rho_i  + m_A N_f + \omega( \Delta_X - {\Delta_M }) \big) \bigg)\\
\end{aligned}
\end{equation}
