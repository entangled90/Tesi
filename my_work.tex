...
In order to obtain the duality without $\eta$ superpotential we start with $N_f + 1 $ flavours and we assignm real masses in the same way as \eqref{eqn:real_mass_reduction_el}. \\
...
Then, the real masses are given by
\begin{equation}
\begin{aligned}
\mu_a = 
  \begin{cases}
