...
The scope of this chapter is to provide an independent check of \cite{Nii:2014jsa} regarding the reduction of KSS duality to three dimensions.\\

We will reduce KSS duality in three dimensions first by calculating the superconformal index in four dimensions and then reducing it to the three dimensional partition function.
