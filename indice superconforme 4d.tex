...
+ & ( \Delta_X -1) k ( k N_f - N_c)  \bigg) 
\end{align*}
Semplificando dei primi termini otteniamo:
\begin{align*}
 4 & m \omega N_c \bigg(   -   N_f  m_A 
 -\Delta_{X} N_{c} - {\left(\Delta_{Q} - 1\right)} N_{f} \bigg) + \\
 + & 4 m \omega (k N_f - N_c) \bigg(
(\Delta_X - 2 + k ( \Delta_X - 1) )   \bigg)  = \\
= 4 & m \omega N_c \bigg(    -   N_f  m_A  
 -\Delta_{X} N_{c} - {\left(\Delta_{Q} - 1\right)} N_{f} \bigg) + \\
 + 4 & m \omega ( k N_f - N_c) \bigg( \Delta_X ( k+1) - k -2 ) \bigg) = \\
 = 4 & m \omega N_c \bigg(    -   N_f  m_A 
 -\Delta_{X} N_{c} - {\left(\Delta_{Q} - 1\right)} N_{f} \bigg) + \\
 + 4 & m \omega ( k N_f - N_c) \big(-k \big)
\end{align*}
...
\centering
\end{table}
Confrontando con la tabella 6 di \citep{Nii:2014jsa} (ricordare che $\Delta_X = \frac{2}{k+1}$).\\
