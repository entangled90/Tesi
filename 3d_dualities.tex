...
Aharony duality can be generalised similarly to Kutasov-Schwimmer duality with respect to Seiberg duality by the addition of a field in the adjoint representation.\\
The electric theory contains $N_f$ flavours of chiral multiplets and a multiplet in the adjoint representation.
...
\begin{array}{ c | c c c c c }
 ...
 \hline
 Q & \Delta_Q & 1 & 0 & N_f & 1 \\  
 \tilde{Q}& \Delta_Q  & 1 & 0  & 1 & \overline{N_f}  \\  
  X & \frac{2}{k+1} & 0 & 0 & 1 & 1 \\ 
 v_{j,\pm} & N_f (1 - \Delta_Q) - \frac{2}{k+1} (N_c-1 - j) & - N_f & \pm 1 & 1  &1 \\
\end{array}
\end{equation}
