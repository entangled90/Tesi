...
For theory withouth quarks, instantons generate a superpotential 
\begin{equation}
...
Since we have $N_f=N_c$ the superpotential \eqref{eqn:3d_sun_nf__n_c_superpot} from the $SU(N_c)$ part of the group and for the $U(1)$ factor we have one flavour given by $X = B \tilde{B}$ 
and with chiral fields $V_+ \, , \,V_-$ with superpotential $W = - X V_+ V_-$.
...
\subsubsection{Monopole operators}
