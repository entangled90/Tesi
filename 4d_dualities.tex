...
The matching of the scales between the electric and mangetich theory results in the following relation between them \cite{Seiberg:1994pq}
%The strong coupling scales of the electric $\Lambda$ and magnetic $\tilde{\Lambda}$ theories are related by the relation \cite{Seiberg:1994pq}
\begin{align}
