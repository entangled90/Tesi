...
Lo scopo di questa tesi consiste nell'applicazione di questa procedura alla dualità KSS che si differenzia da quella di Seiberg per la presenza di un ulteriore campo di materia nella rappresentazione aggiunta del gruppo di gauge. \\
