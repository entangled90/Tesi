...
La riduzione dimensionale di tale teoria era stata effettuata solo in teoria di campo, ma si basa su alcune assunzioni che tutt'ora non sono completamente giustificate.
Il nostro lavoro non necessita di queste ipotesi e si propone quindi come una verifica indipendente a questi risultati.
Inoltre, esso può aiutare la comprensione del processo di riduzione in teoria di campo in quanto lavorando sulla funzione di partizione si ha una chiara visione della fisica del sistema.
Infine, l'identità fra le funzioni di partizione in 3D corrisponde a una identità non banale tra integrali di funzioni iperboliche che non è stata ancora dimostrata in matematica. 
