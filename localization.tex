...
\end{align}
The \emph{single particle index} for a generic chiral field can be written as $i_S$ in the variables $(p,q)$ introduced before and the addition of a generic chemical potential $z$ for the global symmetries. \\
With the same substitution we can write the \emph{single particle index} of a vector multiplet into
\begin{equation}
...
We will provide an explicit calculation for the electric and magnetic theories of Kutasov-Schwimmer duality in the next chapter.
\\
