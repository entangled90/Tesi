...
For a particular range of flavours and colours, both theories flow to a superconformal fixed point and describe the same physical system, even though their dynamics at high energies is different.
...
The dimensional reduction of this duality has been performed only with field theory techniques, which made use of some assumptions that are not completely justified.
