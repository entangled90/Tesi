...
Gauge symmetries can't be anomalous because they would spoil the unitarity of the theory but there's nothing wrong with the global symmetries being anomalous.
We can compute the triangle anomaly for the global symmetry group in the ultraviolet and we will call it $A_{UV}$. 
We can weakly gauge $G$ and we introduce additional fermions that are charged only under $G$ in order to cancel the anomaly, since now it is a gauge symmetry.\\
...
Summarizing the result, we have that if the global symmetry group is not broken by the strong dynamics, triangle anomalies involving only the global symmetry group should be equal in the ultraviolet and in the infrared.
