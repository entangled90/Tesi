...
\text{free magnetic} \qquad V(R) & \sim \frac{1}{R \, \log(R \Lambda) }\\
...
The free electric phases is possible for abelian or non-abelian theories, but in the latter case it's necessary that the renormalization group has a non trivial infrared fixed point.
