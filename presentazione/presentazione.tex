...
%Simile alla dualità di Seiberg ma con l'aggiunta di un campo di materia nell'aggiunta.\\
%Dinamica più complicata e non del tutto compresa in regime di accoppiamento forte.
%\end{block}
