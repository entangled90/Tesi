...
La finitezza del cerchio modifica la dinamica e impone vincoli tipici della teorie 4D (\alert{\bfseries anomalie}).\\
I vincoli sono generati dal superpotenziale $\eta$, generato da istantoni.\\
...
Nel caso della dualità KSS è necessario deformare la teoria
aggiungendo una \alert{\bfseries perturbazione} nel superpotenziale.
\\
Con la deformazione si riescono a trovare i singoletti necessari per la dualità in 3D.
\\
\vspace{0.5cm}
\alert{\bfseries \bfseries Rimuovendo la deformazione non si sa come ottenere i singoletti della teoria magnetica.}
\onslide<2->{
\begin{center}
{\arrowdown}
\end{center}
{\large 
	Devo assumere che rimuovendo la deformazione il risultato non cambia.\\
}
\vspace{0.3cm}
