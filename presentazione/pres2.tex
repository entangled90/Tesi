...
Generalizzazione per teorie di campo supersimmetriche della dualità fra campi elettrici e magnetici di Dirac.\\[0,1cm]
...
Entrambe le teorie nello stesso intervallo di sapori e colori fluiscono a basse energie a un \alert{\bfseries punto fisso superconforme fortemente interagente.}
\\
\vspace{0.2cm}
...
\alert{\bfseries \bfseries Non ho modo di sapere se si osservano i gradi di libertà dell'una o dell'altra teoria.}
\end{center}
}
...
$$
  g_{el} \sim \frac{1}{\tilde{g}_{mag}}  \quad \longrightarrow \quad \hbox{strong-weak coupling}
$$
}
...
\vspace{0.3cm}
Si può calcolare una osservabile nella teoria \alert{\bfseries fortemente accoppiata} (difficile da trattare) con \alert{\bfseries tecniche perturbative} ben note nella teoria duale.\\
...
$$
SU(k N_f - N_c)  = \prod_i^k SU(n_i) \times U(1)^k / U(1)
...
\\
\vspace{0.5cm}
\onslide<3->{L'identità fra le due funzioni di partizione $ Z_{el} = Z_{mag}$ porta a una \alert{\bfseries nuova identità} integrale tra funzioni iperboliche $\Gamma_h$ \alert{\bfseries non ancora dimostrate} matematicamente.
}\\
\end{center}
