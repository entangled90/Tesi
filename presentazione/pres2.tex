...
\alert{\bfseries Non ho modo di sapere se si osservano i gradi di libertà dell'una o dell'altra teoria.}
\end{center}
}
...
\onslide<+->{Per tutte le dualità elettriche-magnetiche vale la relazione 
$$
...
\onslide<+->{
Quando una delle due teoria è fortemente accoppiata, la teoria duale è in regime perturbativo.\\
\vspace{0.3cm}
Si può calcolare una osservabile nella teoria \alert{fortemente accoppiata} (difficile da trattare) con \alert{tecniche perturbative} ben note nella teoria duale.\\
...
\onslide<2->{
 ...
 \vspace{0.3cm}
	{ \centering \alert{Monopoli} della teoria elettrica  $\longrightarrow $ \alert{singoletti} nella teoria magnetica\\
	}
\vspace{0.3cm}
...
\vspace{0.3cm}
Il superpotenziale $\eta$ impone vincoli tipici delle 4D (\alert{anomalie}). \\
...
\vspace{1cm}
Si genera anche la simmetria assiale che è anomala in 4D, ma che è permessa in 3D.\\
I vincoli sulle cariche dei campi vengono rimossi.
\end{block}
...
è necessario deformare la teoria aggiungendo una \alert{perturbazione} nel superpotenziale. \\
\vspace{0.3cm}
Nella teoria duale, essa rompe la teoria in $k$ settori \alert{senza aggiunta} con gruppo di gauge 
$$
...
\alert{\bfseries Rimuovendo la deformazione $U(1)^k \longrightarrow U(k)$ e non si sa come ottenere i singoletti della teoria magnetica.}
\onslide<2->{
\begin{center}
{\arrowdown}
\end{center}
...
\vspace{0.3cm}
\alert{Non è chiaro come si può giustificare questa affermazione.}
}
\end{frame}
...
\\
\vspace{0.5cm}
\onslide<3->{L'identità fra le due funzioni di partizione $ Z_{el} = Z_{mag}$ porta a una \alert{nuova identità} integrale tra funzioni iperboliche $\Gamma_h$ \alert{non ancora dimostrate} matematicamente.
}\\
\end{center}
